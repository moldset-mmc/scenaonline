      ...
      <main>
        ...
        <section className="cover-example" id="example" aria-labelledby="example-title">
          ...
          <div className="example-layout">
            ...
            <div className="example-copy"><span className="example-tag">ДЕМОНСТРАЦИОННЫЙ САЙТ</span><h3>Sofi Leroux</h3><p>Визажист. Модель. Своя студия.<br/>И одна ссылка, чтобы познакомиться,<br className="desktop-break"/> посмотреть работы и записаться.</p><a className="example-live-link" href="https://sofileroux.scena.life/ru/" target="_blank" rel="noreferrer">Открыть сайт <ArrowUpRight size={18}/></a><p className="example-disclaimer">Софи — вымышленная героиня. Образ создан с помощью ИИ для показа возможностей сайта.</p></div>
          </div>
        </section>
